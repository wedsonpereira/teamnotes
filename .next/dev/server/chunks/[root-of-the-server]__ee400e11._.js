...
"[project]/app/api/rooms/[roomId]/pages/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        let pages = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.findMany({
            where: {
                roomId
            },
            select: {
        ...
        if (pages.length === 0) {
            ...
            const defaultPage = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.create({
                data: {
                    roomId,
                    title: "Page 1",
                    sortOrder: 0,
            ...
            pages = [
                {
                    ...
                    createdAt: defaultPage.createdAt
                }
            ];
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request, { params }) {
    try {
        ...
        const lastPage = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.findFirst({
            where: {
                roomId
            },
            orderBy: {
        ...
        // Count existing pages for default naming
        const count = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.count({
            where: {
                roomId
            }
        });
        const page = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].page.create({
            data: {
                roomId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee400e11._.js.map